...
\end{itemize}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}4}]:} \PY{n}{all\PYZus{}train\PYZus{}dataset} \PY{o}{=} \PY{n}{pd}\PY{o}{.}\PY{n}{read\PYZus{}csv}\PY{p}{(}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{./inputs/train.csv}\PY{l+s+s2}{\PYZdq{}}\PY{p}{)}
...
\end{Verbatim}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}5}]:} \PY{n}{all\PYZus{}test\PYZus{}dataset} \PY{o}{=} \PY{n}{pd}\PY{o}{.}\PY{n}{read\PYZus{}csv}\PY{p}{(}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{./inputs/test.csv}\PY{l+s+s2}{\PYZdq{}}\PY{p}{)}
...
understanding of data types.
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}12}]:} \PY{c+c1}{\PYZsh{} all\PYZus{}train\PYZus{}dataset.info()}
         \PY{k}{for} \PY{n}{col} \PY{o+ow}{in} \PY{n}{train\PYZus{}input}\PY{o}{.}\PY{n}{columns}\PY{p}{:}
             \PY{k}{if}\PY{p}{(}\PY{n}{col} \PY{o}{==} \PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{param\PYZus{}1}\PY{l+s+s2}{\PYZdq{}} \PY{o+ow}{or} \PY{n}{col} \PY{o}{==} \PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{param\PYZus{}2}\PY{l+s+s2}{\PYZdq{}} \PY{o+ow}{or} \PY{n}{col} \PY{o}{==} \PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{param\PYZus{}3}\PY{l+s+s2}{\PYZdq{}} \PY{o+ow}{or} \PY{n}{col} \PY{o}{==} \PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{description}\PY{l+s+s2}{\PYZdq{}} \PY{o+ow}{or} \PY{n}{col} \PY{o}{==} \PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{image}\PY{l+s+s2}{\PYZdq{}}\PY{p}{)}\PY{p}{:} \PY{c+c1}{\PYZsh{} as NA exist in these columns}
                 \PY{n+nb}{print}\PY{p}{(}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{Column Name:}\PY{l+s+s2}{\PYZdq{}}\PY{p}{,} \PY{n}{col}\PY{p}{,} \PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{    \PYZsh{}Unique Values(+1 extra):}\PY{l+s+s2}{\PYZdq{}}\PY{p}{,} \PY{n+nb}{len}\PY{p}{(}\PY{n}{np}\PY{o}{.}\PY{n}{unique}\PY{p}{(}\PY{n}{train\PYZus{}input}\PY{p}{[}\PY{n}{col}\PY{p}{]}\PY{o}{.}\PY{n}{fillna}\PY{p}{(}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{missing}\PY{l+s+s2}{\PYZdq{}}\PY{p}{)}\PY{p}{)}\PY{p}{)}\PY{p}{)}
             \PY{k}{else}\PY{p}{:}
                 \PY{n+nb}{print}\PY{p}{(}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{Column Name:}\PY{l+s+s2}{\PYZdq{}}\PY{p}{,} \PY{n}{col}\PY{p}{,} \PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{    \PYZsh{}Unique Values:}\PY{l+s+s2}{\PYZdq{}}\PY{p}{,} \PY{n+nb}{len}\PY{p}{(}\PY{n}{np}\PY{o}{.}\PY{n}{unique}\PY{p}{(}\PY{n}{train\PYZus{}input}\PY{p}{[}\PY{n}{col}\PY{p}{]}\PY{p}{)}\PY{p}{)}\PY{p}{)}
\end{Verbatim}


    \begin{Verbatim}[commandchars=\\\{\}]
Column Name: item\_id     \#Unique Values: 1503424
Column Name: user\_id     \#Unique Values: 771769
Column Name: region     \#Unique Values: 28
Column Name: city     \#Unique Values: 1733
Column Name: parent\_category\_name     \#Unique Values: 9
Column Name: category\_name     \#Unique Values: 47
Column Name: param\_1     \#Unique Values(+1 extra): 372
Column Name: param\_2     \#Unique Values(+1 extra): 272
Column Name: param\_3     \#Unique Values(+1 extra): 1220
...
Column Name: item\_seq\_number     \#Unique Values: 28232
Column Name: activation\_date     \#Unique Values: 21
Column Name: user\_type     \#Unique Values: 3
Column Name: image     \#Unique Values(+1 extra): 1390837
Column Name: image\_top\_1     \#Unique Values: 115650

    \end{Verbatim}

    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}6}]:} \PY{n}{train\PYZus{}output} \PY{o}{=} \PY{n}{all\PYZus{}train\PYZus{}dataset}\PY{p}{[}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{deal\PYZus{}probability}\PY{l+s+s1}{\PYZsq{}}\PY{p}{]}\PY{o}{.}\PY{n}{astype}\PY{p}{(}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{float32}\PY{l+s+s1}{\PYZsq{}}\PY{p}{)}
...
towards low range in \texttt{deal\_probability}.
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}13}]:} \PY{n}{plt}\PY{o}{.}\PY{n}{figure}\PY{p}{(}\PY{n}{figsize}\PY{o}{=}\PY{p}{(}\PY{l+m+mi}{20}\PY{p}{,} \PY{l+m+mi}{10}\PY{p}{)}\PY{p}{)}
...
\end{Verbatim}
    ...
    Below 3 graphs shows that \texttt{region}, \texttt{Category\ Name} and
\texttt{Parent\ Category\ Name} have few unique values which can be
encoded to numeric data for model training.
...
\end{Verbatim}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}8}]:} \PY{n}{plt}\PY{o}{.}\PY{n}{figure}\PY{p}{(}\PY{n}{figsize}\PY{o}{=}\PY{p}{(}\PY{l+m+mi}{20}\PY{p}{,} \PY{l+m+mi}{8}\PY{p}{)}\PY{p}{)}
...
\end{Verbatim}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}9}]:} \PY{n}{plt}\PY{o}{.}\PY{n}{figure}\PY{p}{(}\PY{n}{figsize}\PY{o}{=}\PY{p}{(}\PY{l+m+mi}{20}\PY{p}{,} \PY{l+m+mi}{8}\PY{p}{)}\PY{p}{)}
...
My benchmark model failed on this step only. As I checked my model
submission on kaggle private dataset, I am getting accuracy to what I
expect with the limited dataset I used here. Because of reduction of
dataset, Image processing \& text to word vector conversion got skiped
which made the model fast to predict to comparable best models exist for
this problems at kaggle. Hence, These models seems to be robust.
Alongside this, the model seems to be trustable and aligns well with
...
\subsubsection{Free-Form Visualization}\label{free-form-visualization}}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}10}]:} \PY{n+nb}{print}\PY{p}{(}\PY{n}{np}\PY{o}{.}\PY{n}{sum}\PY{p}{(}\PY{n}{train\PYZus{}output} \PY{o}{\PYZgt{}} \PY{l+m+mf}{0.5}\PY{p}{)}\PY{p}{)}
